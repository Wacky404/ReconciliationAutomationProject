...
for cell in ws_uasys['F']:
    ...
    #     else:
    #         GOV_ADDRESS_LINE_2 = found.group(1)
    #         if GOV_ADDRESS_LINE_2.find('PO Box') != -1:
    #             ws_uasys['H' + str(cell.row)].value = GOV_ADDRESS_LINE_2
    #         else:
    #             ws_uasys['G' + str(cell.row)].value = GOV_ADDRESS_LINE_2.upper()
    #     change_address = re.sub(str(found.group(1)), "", governing_address)
    #     ws_uasys['F' + str(cell.row)].value = change_address
    # elif governing_address.find('# ') != -1 and governing_address.find('Unit') == -1:
    ...
    #     change_address = re.sub(str(found.group(1)), "", governing_address)
    #     ws_uasys['F' + str(cell.row)].value = change_address
    # elif governing_address.find('PO Box') != -1:
    ...
    #     change_address = re.sub(str(found.group(1)), "", governing_address)
    #     ws_uasys['F' + str(cell.row)].value = change_address
    # elif governing_address.find('Floor') != -1:
    #     x = governing_address.split()
    #     list = len(x)
    #     txt = str(x[2:list])
    #     found = re.search("[0-99](.+?Floor$)", txt)
    #     if not found:
    #         continue
    #     else:
    #         GOV_ADDRESS_LINE_2 = found.group(1)
    ...
    #             ws_uasys['G' + str(cell.row)].value = GOV_ADDRESS_LINE_2.upper()
    #     if found is None:
    #         change_address = governing_address
    #     else:
    #         change_address = re.sub(str(found.group(1)), "", governing_address)
    #     ws_uasys['F' + str(cell.row)].value = change_address
    #
